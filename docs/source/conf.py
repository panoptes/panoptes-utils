...
htmlhelp_basename = 'PANOPTESUtilsdoc'
...
latex_documents = [
    (master_doc, 'PANOPTESUtils.tex', 'PANOPTES Utils Documentation',
...
man_pages = [
    (master_doc, 'panoptesutils', 'PANOPTES Utils Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PANOPTESUtils', 'PANOPTES Utils Documentation',
     author, 'PANOPTESUtils', 'One line description of project.',
     'Miscellaneous'),
]
