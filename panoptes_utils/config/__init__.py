...
def get_config(host='127.0.0.1', port='5000', key=None, parse=True):
    ...
    Args:
        ...
        port (str, optional): The config server port, defaults to 5000.
...
def set_config(key, new_value, host='127.0.0.1', port='5000', parse=True):
