 ...
 * Added a `panoptes-utils telemetry` daemon command with append-only NDJSON logging for system/run streams, noon-boundary system rotation, and `/current` snapshot support. #XXX
